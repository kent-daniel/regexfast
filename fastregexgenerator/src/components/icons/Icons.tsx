...
const CopyIconSuccess: React.FC<IconProps> = ({ className, ...props }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
const JavascriptIcon: React.FC<IconProps> = ({ className, ...props }) => {
  return (
    <svg
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        <path d="M0 0h256v256H0V0z" fill="#ffe100"></path>
...
export { CopyIcon, CopyIconSuccess, JavascriptIcon, ArrowDownIcon };
